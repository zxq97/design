...
var ProviderSet = wire.NewSet(NewDB, NewRedis, NewMemCache, NewKafkaProducer, NewArchiveRepo)

func NewDB() *gorm.DB {
	conn, err := gorm.Open(mysql.Open("root:GUOan1992@tcp(127.0.0.1:3306)/zzlove_archive?charset=utf8mb4&parseTime=True&loc=Local"), &gorm.Config{})
	if err != nil {
		panic(err)
	}
	return conn
